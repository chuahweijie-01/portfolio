...
const About = () => {
    ...
    const linkedInButtonConf = {
        ...
        bgcolor: "bg-slate-800 dark:bg-white",
            ...
            <div className="flex pt-5 gap-10 flex-col-reverse lg:flex-row pb-8">
                <div className="flex-1 lg:flex-2/3">
                    <div className="flex flex-col justify-between h-full">
                        <header className='text-4xl pb-4 text-black dark:text-white'>
                            I&apos;m Kelvin — a Full-stack Developer
                        </header>
                        <div className='text-xm text-gray-500 dark:text-white flex flex-col gap-7 pr-10'>
                            <div>
